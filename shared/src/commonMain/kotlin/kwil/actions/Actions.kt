...
object ActionSchema {
    val schemas =
        mapOf(
            ...
            "get_user" to
                listOf(),
            "get_user_as_inserter" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "upsert_wallet_as_inserter" to
                listOf(
                    SchemaField("id", DataType.Uuid),
            ...
            "upsert_credential_as_inserter" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                    SchemaField("user_id", DataType.Uuid),
            ...
            "get_credentials" to
                listOf(),
            "get_credentials_shared_by_user" to
                listOf(
                    SchemaField("user_id", DataType.Uuid),
                    SchemaField("issuer_auth_public_key", DataType.Text),
                ),
            ...
            "edit_public_notes_as_issuer" to
                listOf(
                    SchemaField("public_notes_id", DataType.Text),
                    SchemaField("public_notes", DataType.Text),
                ),
            "remove_credential" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "share_credential" to
            ...
            "share_credential_through_dag" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                    SchemaField("user_id", DataType.Uuid),
                    SchemaField("issuer_auth_public_key", DataType.Text),
            ...
            "credential_exist_as_inserter" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "get_credential_owned" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "get_credential_shared" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "get_sibling_credential_id" to
                listOf(
                    SchemaField("content_hash", DataType.Text),
                ),
            "credential_belongs_to_caller" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "credential_exist" to
            ...
            "revoke_access_grant" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "get_access_grants_owned" to
                listOf(),
            "get_access_grants_granted" to
                listOf(
                    SchemaField("user_id", DataType.Uuid),
                    SchemaField("page", DataType.Int),
                    SchemaField("size", DataType.Int),
                ),
            "get_access_grants_granted_count" to
                listOf(
                    SchemaField("user_id", DataType.Uuid),
                ),
            "has_locked_access_grants" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "dag_message" to
            ...
            "get_access_grants_for_credential" to
                listOf(
            ...
            "add_passporting_club_as_owner" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                    SchemaField("name", DataType.Text),
                ),
            "delete_passporting_club_as_owner" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "add_passporting_peer_as_owner" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                    SchemaField("name", DataType.Text),
                    SchemaField("issuer_public_key", DataType.Text),
            ...
            "delete_passporting_peer_as_owner" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                ),
            "update_passporting_peer_as_owner" to
                listOf(
                    SchemaField("id", DataType.Uuid),
                    SchemaField("name", DataType.Text),
                    SchemaField("issuer_public_key", DataType.Text),
...
suspend fun addInserterAsOwner(
    ...
    client.executeAction(
        ...
        "Add inserter as owner",
        true,
    )

suspend fun deleteInserterAsOwner(
    client: KwilActionClient,
    id: String,
): String? =
    client.executeAction(
        ...
        "Delete inserter as owner",
        true,
    )

suspend fun addDelegateAsOwner(
    client: KwilActionClient,
    address: String,
    inserterId: String,
): String? =
    client.executeAction(
        ...
        "Add a delegate as owner",
        true,
    )

suspend fun deleteDelegateAsOwner(
    client: KwilActionClient,
    address: String,
): String? =
    client.executeAction(
...
suspend fun getInserter(client: KwilActionClient): GetInserterResponse =
    client
        .callAction<GetInserterResponse>(
            "get_inserter",
            mapOf(),
        ).first()
...
suspend fun getInserterOrNull(client: KwilActionClient): GetInserterOrNullResponse =
    client
        .callAction<GetInserterOrNullResponse>(
            "get_inserter_or_null",
            mapOf(),
        ).first()
//  USER ACTIONS

suspend fun addUserAsInserter(
    client: KwilActionClient,
    id: String,
...
suspend fun updateUserPubKeyAsInserter(
    client: KwilActionClient,
    id: String,
    recipientEncryptionPublicKey: String,
    encryptionPasswordStore: String,
    ...
    client.executeAction(
        ...
        "Update user's encryption key and password store in idOS",
        true,
    )
...
suspend fun getUserAsInserter(
    client: KwilActionClient,
    id: String,
): GetUserAsInserterResponse =
    client
        .callAction<GetUserAsInserterResponse>(
...
suspend fun upsertWalletAsInserter(
    client: KwilActionClient,
    id: String,
    userId: String,
    address: String,
...
suspend fun getWallets(client: KwilActionClient): List<GetWalletsResponse> =
    client.callAction<GetWalletsResponse>(
        "get_wallets",
        mapOf(),
    )
...
suspend fun removeWallet(
    ...
    client.executeAction(
        ...
        "Remove a wallet from idOS",
        true,
    )
//  CREDENTIAL ACTIONS
//  throw an error if not authorized

suspend fun upsertCredentialAsInserter(
    client: KwilActionClient,
    id: String,
    userId: String,
    ...
    client.executeAction(
        ...
        "Add or update a credential in idOS on behalf of a user",
        true,
    )
...
suspend fun getCredentials(client: KwilActionClient): List<GetCredentialsResponse> =
    client.callAction<GetCredentialsResponse>(
        "get_credentials",
        mapOf(),
    )
...
suspend fun getCredentialsSharedByUser(
    client: KwilActionClient,
    userId: String,
    issuerAuthPublicKey: String?,
): List<GetCredentialsSharedByUserResponse> =
    client.callAction<GetCredentialsSharedByUserResponse>(
...
suspend fun editPublicNotesAsIssuer(
    client: KwilActionClient,
    ...
    client.executeAction(
        ...
        "Edit a credential in your idOS profile",
        true,
    )
...
suspend fun removeCredential(
    ...
    client.executeAction(
        ...
        "Remove a credential from your idOS profile",
        true,
    )
...
suspend fun shareCredential(
    ...
    client.executeAction(
        ...
        "Share a credential with another idOS user",
        true,
    )
//  Passporting scenario

suspend fun createCredentialCopy(
    client: KwilActionClient,
    id: String,
    originalCredentialId: String,
    publicNotes: String,
...
suspend fun shareCredentialThroughDag(
    ...
    client.executeAction(
        ...
        "Share a credential through the DAG",
        true,
    )
//  For access grant
...
suspend fun createCredentialsByDwg(
    client: KwilActionClient,
    issuerAuthPublicKey: String,
    ...
    client.executeAction(
        ...
        "Create a new credential in your idOS profile",
        true,
    )
...
suspend fun credentialExistAsInserter(
    client: KwilActionClient,
    id: String,
): CredentialExistAsInserterResponse =
    client
        .callAction<CredentialExistAsInserterResponse>(
...
suspend fun getCredentialOwned(
    client: KwilActionClient,
    id: String,
): List<GetCredentialOwnedResponse> =
    client.callAction<GetCredentialOwnedResponse>(
...
suspend fun getCredentialShared(
    client: KwilActionClient,
    id: String,
): List<GetCredentialSharedResponse> =
    client.callAction<GetCredentialSharedResponse>(
...
suspend fun getSiblingCredentialId(
    client: KwilActionClient,
    contentHash: String,
): GetSiblingCredentialIdResponse =
    client
        .callAction<GetSiblingCredentialIdResponse>(
...
suspend fun credentialBelongsToCaller(
    client: KwilActionClient,
    id: String,
): CredentialBelongsToCallerResponse =
    client
        .callAction<CredentialBelongsToCallerResponse>(
...
suspend fun credentialExist(
    client: KwilActionClient,
    id: String,
): CredentialExistResponse =
    client
        .callAction<CredentialExistResponse>(
            "credential_exist",
            mapOf(
                "id" to id,
            ),
...
suspend fun addAttributeAsInserter(
    client: KwilActionClient,
    id: String,
    userId: String,
    attributeKey: String,
    ...
    client.executeAction(
        ...
        "Add a new attribute as inserter",
        true,
    )
...
suspend fun addAttribute(
    ...
    client.executeAction(
        ...
        "Create a new attribute in your idOS profile",
        true,
    )
...
suspend fun getAttributes(client: KwilActionClient): List<GetAttributesResponse> =
    client.callAction<GetAttributesResponse>(
        "get_attributes",
        mapOf(),
    )
...
suspend fun revokeAccessGrant(
    ...
    client.executeAction(
        ...
        "Revoke an Access Grant from idOS",
        true,
    )
...
suspend fun getAccessGrantsOwned(client: KwilActionClient): List<GetAccessGrantsOwnedResponse> =
    client.callAction<GetAccessGrantsOwnedResponse>(
...
suspend fun getAccessGrantsGranted(
    client: KwilActionClient,
    userId: String?,
    page: Int,
    size: Int,
): List<GetAccessGrantsGrantedResponse> =
    client.callAction<GetAccessGrantsGrantedResponse>(
...
suspend fun getAccessGrantsGrantedCount(
    client: KwilActionClient,
    userId: String?,
): GetAccessGrantsGrantedCountResponse =
    client
        .callAction<GetAccessGrantsGrantedCountResponse>(
...
suspend fun hasLockedAccessGrants(
    client: KwilActionClient,
    id: String,
): HasLockedAccessGrantsResponse =
    client
        .callAction<HasLockedAccessGrantsResponse>(
...
suspend fun createAgByDagForCopy(
    client: KwilActionClient,
    dagOwnerWalletIdentifier: String,
    dagGranteeWalletIdentifier: String,
    dagDataId: String,
...
suspend fun getAccessGrantsForCredential(
    client: KwilActionClient,
    credentialId: String,
): List<GetAccessGrantsForCredentialResponse> =
    client.callAction<GetAccessGrantsForCredentialResponse>(
...
suspend fun addPassportingClubAsOwner(
    client: KwilActionClient,
    id: String,
    name: String,
): String? =
    client.executeAction(
        ...
        "Add a new passporting club as owner",
        true,
    )

suspend fun deletePassportingClubAsOwner(
    client: KwilActionClient,
    id: String,
): String? =
    client.executeAction(
        ...
        "Delete a passporting club as owner",
        true,
    )

suspend fun addPassportingPeerAsOwner(
    client: KwilActionClient,
    id: String,
    name: String,
    issuerPublicKey: String,
    passportingServerUrlBase: String,
): String? =
    client.executeAction(
        ...
        "Update a passporting peer as owner",
        true,
    )

suspend fun deletePassportingPeerAsOwner(
    client: KwilActionClient,
    id: String,
): String? =
    client.executeAction(
        ...
        "Delete a passporting peer as owner",
        true,
    )

suspend fun updatePassportingPeerAsOwner(
    client: KwilActionClient,
    id: String,
    name: String,
    issuerPublicKey: String,
...
suspend fun addPeerToClubAsOwner(
    client: KwilActionClient,
    passportingClubId: String,
    passportingPeerId: String,
): String? =
    client.executeAction(
        ...
        "Add a peer to a passporting club as owner",
        true,
    )

suspend fun deletePeerFromClubAsOwner(
    client: KwilActionClient,
    passportingClubId: String,
    passportingPeerId: String,
): String? =
    client.executeAction(
        ...
        "Delete a peer from a passporting club as owner",
        true,
    )
...
suspend fun getPassportingPeers(client: KwilActionClient): List<GetPassportingPeersResponse> =
    client.callAction<GetPassportingPeersResponse>(
